...
const SoundSettings: React.FC = () => {
    ...
    useEffect(() => setSimVar("L:A32NX_SOUND_EXTERIOR_MASTER", exteriorVolume, "number"), [exteriorVolume]);
    useEffect(() => setSimVar("L:A32NX_SOUND_INTERIOR_ENGINE", engineVolume, "number"), [engineVolume]);
    useEffect(() => setSimVar("L:A32NX_SOUND_INTERIOR_WIND", windVolume, "number"), [windVolume]);
